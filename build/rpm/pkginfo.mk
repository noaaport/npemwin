...
Requires = tcp_wrappers-libs db4 tcl tcllib tclxml gnuplot unzip

ifeq (${FLAVOR}, opensuse)
rpmroot = /usr/src/packages
Requires = tcpd libdb_4_5 tcl tcllib tclxml gnuplot unzip
endif

ifeq (${FLAVOR}, centos)
Requires = tcp_wrappers tcl tcllib tclxml gnuplot unzip
endif
