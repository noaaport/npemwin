...
# Examples:
#
## wget 'http://diablo:8016/_export/query_list?select=nwx'
## wget 'http://diablo:8016/_export/query_dir? \
#    dir=digatmos/nwx/watch_warn/flw&select=20081211'
## wget 'http://diablo:8016/_export_get/ \
...
set export(exportdirsdef) [list "export-da.def"];
