dset /usr/local/etc/npemwin/defaults/grads/track/map.grb
index /usr/local/etc/npemwin/defaults/grads/track/map.idx
undef 9.999E+20
title /usr/local/etc/npemwin/defaults/grads/track/map.grb
